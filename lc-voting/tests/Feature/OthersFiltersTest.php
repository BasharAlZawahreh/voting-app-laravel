...
class OthersFiltersTest extends TestCase
{
    ...
    /** @test */
    public function top_voted_filters_works_correctly()
    {
    ...
    /** @test */
    public function my_ideas_filters_works_correctly_when_user_is_loged_in()
    {
    ...
    /** @test */
    public function my_ideas_filters_works_correctly_when_user_is_not_loged_in()
    {
    ...
    /** @test */
    public function my_ideas_filters_works_correctly_with_categories()
    {
