<div
    ...
    x-init="
        ...
        const commentWeWant = document.querySelector('#comment-{{session('scrollToComment')}}')
        commentWeWant.scrollIntoView({ behavior: 'smooth'})
        commentWeWant.classList.add('bg-green-50')
        setTimeout(() => {
            commentWeWant.classList.remove('bg-green-50')
        }, 5000)
        @endif
    "
    class="relative"
