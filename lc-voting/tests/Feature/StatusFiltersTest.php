...
class StatusFiltersTest extends TestCase
{
    ...
    public function shows_correct_status_count()
    {
        ...
        $statusImplemented = Status::factory()->create(['id' => 4, 'name' => 'Implemented', 'classes' => 'bg-blue text-white']);
    ...
    public function filtering_works_when_query_string_in_place()
    {
        ...
        $statusImplemented = Status::factory()->create(['name' => 'Implemented', 'classes' => 'bg-blue text-white']);
        $statusConsidering = Status::factory()->create(['name' => 'Considering ', 'classes' => 'bg-purple text-white']);
        $statusInProgress = Status::factory()->create(['name' => 'InProgress', 'classes' => 'bg-purple text-white']);
        ...
        // $response->assertSee('<div class="bg-purple text-white text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">In Progress</div>', false);
